...
def set_cfg(cfg):
    ...
    # cache dir
    cfg.dataset.dir = '/data/dataset/dataset/datasets'
    ...
    cfg.train.negative_sample_k = 1

    cfg.train.negative_sample_method = 'uniform'
    # ------------------------------------------------------------------------ #
    # Validation options
    # ------------------------------------------------------------------------ #
    cfg.val = CN()
    ...
    # loss type ranking or not
    cfg.model.loss_type = 'normal'
